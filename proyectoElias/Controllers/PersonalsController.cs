...
namespace gimnasioGestion.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        public PersonalsController(GimnasioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PersonalId,NombrePersonal,Edad,Direccion,Salario")] Personal personal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonalId,NombrePersonal,Edad,Direccion,Salario")] Personal personal)
        {
