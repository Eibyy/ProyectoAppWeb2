...
namespace gimnasioGestion.Controllers
{
    public class EquipoesController : Controller
    {
        ...
        public EquipoesController(GimnasioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EquipoId,NombreEquipo,Marca,Modelo")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EquipoId,NombreEquipo,Marca,Modelo")] Equipo equipo)
        {
